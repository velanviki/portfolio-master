        ...
        <div class="project container " data-aos="fade-right">
          ...
          <div class="col-right">
            <h2> Wishes - MERN </h2>
              ...
              <a
              href="https://mern-wishes.netlify.app"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
              <i class="fa-solid fa-check-double" id="git"></i> Demo
            </a>
            <a
              ...
              target="_blank"
            >
              <i class="fa-brands fa-github" id="git"></i> GitHub
            </a>
          ...
          <div class="col-right">
            <h2> Quizz App </h2>
              ...
              <a
              href="https://quizz-app-vicky.netlify.app"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <a
              href="https://github.com/velanviki/mern-quiz-app"
              class="cta"
              rel="noopener noreferrer"
              target="_blank"
            >
          ...
          <div class="col-left">
            <div class="project-img" data-aos="fade-in">
              <img
                src="https://img.freepik.com/premium-vector/comic-speech-bubbles-with-text-quiz-night-neon-icon-symbol-sticker-tag-special-offer-label_100456-7641.jpg"
                alt="img"
              />
            </div>
          </div>
